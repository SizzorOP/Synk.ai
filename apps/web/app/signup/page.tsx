...
<h2 className="text-slate-900 dark:text-white text-4xl font-black tracking-tight">Create Account</h2>
<p className="text-slate-500 dark:text-slate-400 text-base">Initialize your synk with the collective ecosystem.</p>
</div>
