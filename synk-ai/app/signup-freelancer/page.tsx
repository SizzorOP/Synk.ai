...
<h2 className="text-slate-900 dark:text-white text-4xl font-black tracking-tight">Talent Application</h2>
<p className="text-slate-500 dark:text-slate-400 text-base">Initialize your tech portfolio with the collective ecosystem.</p>
</div>
<form className="flex flex-col gap-5" onSubmit={handleSubmit}>
<div className="grid grid-cols-2 gap-4">
<label className="flex flex-col gap-2">
<span className="text-slate-700 dark:text-slate-300 text-sm font-semibold">First Name</span>
<input className="form-input flex w-full rounded-lg text-slate-900 dark:text-white focus:ring-2 focus:ring-primary/50 border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 h-12 px-4 text-base transition-all outline-none" placeholder="Case" type="text"/>
</label>
<label className="flex flex-col gap-2">
<span className="text-slate-700 dark:text-slate-300 text-sm font-semibold">Last Name</span>
<input className="form-input flex w-full rounded-lg text-slate-900 dark:text-white focus:ring-2 focus:ring-primary/50 border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 h-12 px-4 text-base transition-all outline-none" placeholder="Molly" type="text"/>
</label>
</div>
<label className="flex flex-col gap-2">
...
<input className="form-input flex w-full rounded-lg text-slate-900 dark:text-white focus:ring-2 focus:ring-primary/50 border border-slate-300 dark:border-slate-700 bg-white dark:bg-slate-900 h-12 pl-11 pr-4 text-base transition-all outline-none" placeholder="neural_link@synk.ai" type="email"/>
</div>
</label>
<label className="flex flex-col gap-2">
